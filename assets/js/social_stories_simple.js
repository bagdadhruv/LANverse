// Simplified social stories with reliable placeholder images
const parties = [
  {
    poster: 'https://placehold.co/600x180/23234d/fff?text=NeonJam+Party',
    host: '@vibeyjen',
    hostAvatar: 'https://placehold.co/56x56/ff4ecd/fff?text=V',
    eventTag: '#NeonJam',
    stories: [
      { media: 'https://placehold.co/600x400/23234d/00eaff?text=NeonJam+Story+1', type: 'image', username: '@vibeyjen' },
      { media: 'https://www.w3schools.com/html/mov_bbb.mp4', type: 'video', username: '@vibeyjen' },
      { media: 'https://placehold.co/600x400/23234d/ff4ecd?text=NeonJam+Story+2', type: 'image', username: '@vibeyjen' }
    ]
  },
  {
    poster: 'https://placehold.co/600x180/23234d/fff?text=GlowFest+Party',
    host: '@djNova',
    hostAvatar: 'https://placehold.co/56x56/00eaff/fff?text=D',
    eventTag: '#GlowFest',
    stories: [
      { media: 'https://placehold.co/600x400/23234d/a259ff?text=GlowFest+Story+1', type: 'image', username: '@djNova' },
      { media: 'https://www.w3schools.com/html/mov_bbb.mp4', type: 'video', username: '@djNova' },
      { media: 'https://placehold.co/600x400/23234d/00eaff?text=GlowFest+Story+2', type: 'image', username: '@djNova' }
    ]
  },
  {
    poster: 'https://placehold.co/600x180/23234d/fff?text=Cyberpunk+Party',
    host: '@cyberpunk1',
    hostAvatar: 'https://placehold.co/56x56/a259ff/fff?text=C',
    eventTag: '#Cyberpunk',
    stories: [
      { media: 'https://placehold.co/600x400/23234d/ff4ecd?text=Cyberpunk+Story+1', type: 'image', username: '@cyberpunk1' },
      { media: 'https://www.w3schools.com/html/mov_bbb.mp4', type: 'video', username: '@cyberpunk1' }
    ]
  }
];
...
function setPosterWithFallback(img, src) {
  img.onerror = () => { 
    console.error('Poster failed to load:', src);
    img.onerror = null; 
    img.src = 'https://placehold.co/600x180/23234d/fff?text=Party+Poster'; 
  };
  img.src = src;
  console.log('Setting poster:', src);
}
...
function setAvatarWithFallback(img, src) {
  img.onerror = () => { 
    ...
    img.onerror = null; 
    img.src = 'https://placehold.co/56x56/ff4ecd/fff?text=Avatar'; 
  };
  img.src = src;
  console.log('Setting avatar:', src);
}

function renderPartyCard() {
  const party = parties[currentParty];
  console.log('Rendering party card for:', party);
...
function renderStories() {
  ...
  party.stories.forEach((story, idx) => {
    ...
    if (story.type === 'image') {
      ...
      img.src = story.media;
      img.alt = 'Story';
      img.onload = () => console.log('Image loaded successfully:', story.media);
...
document.addEventListener('DOMContentLoaded', function() {
  console.log('DOM loaded, initializing social stories...');
  renderPartyCard();
}); 